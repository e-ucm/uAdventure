    ...
    public class Controller
    {
        ...
        */
        public void Init(string loadProjectPath = null)
        {
            ...
            var currentGamePath = UAdventurePaths.PROJECT_RESOURCES_PATH + "CurrentGame";
        ...
        private bool newAdventureFile(string fileName, int fileType)
        {
            ...
            if (create)
            {
                ...
                AssetsController.copyAssets(currentZipFile, new DirectoryInfo(UAdventurePaths.PROJECT_RESOURCES_PATH).FullName);
        ...
        public bool NewAdventure(int fileType)
        {
            ...
            string currentGamePath = UAdventurePaths.PROJECT_RESOURCES_PATH + "CurrentGame";
            bool fileCreated = false;
            bool create = false;
                ...
                if (completeFilePath != null)
                {
                    ...
                    if (isValidTargetProject(newFile))
                    {
                        ...
                        if (saveAs)
                        {
                            ...
                            //loadingScreen.setVisible(true);
                            AssetsController.copyAssets(new DirectoryInfo(UAdventurePaths.PROJECT_RESOURCES_PATH).FullName, currentZipFile);
        ...
        private void DoBuild(BuildConfig config)
        {
            ...
            string[] scenes = new string[] { "Packages/es.e-ucm.uadventure/Runtime/uAdventure/Scenes/_Scene1.unity" };
