...
namespace uAdventure.Editor
{
    public class ConfigData
    {
        ...
        private void checkConsistency()
        {
            ...
            if (aboutFile == null)
            {
                aboutFile = UAdventurePaths.EDITOR_RESOURCES_PATH + ReleaseFolders.LANGUAGE_DIR_EDITOR + "/" + ReleaseFolders.getDefaultAboutFilePath();
            }
            if (loadingImage == null)
            {
                loadingImage = UAdventurePaths.EDITOR_RESOURCES_PATH + "EAdventureData/" + ReleaseFolders.IMAGE_LOADING_DIR + "/" + Controller.Instance.getDefaultLanguage() + "/Editor2D-Loading.png";
            }
        }
