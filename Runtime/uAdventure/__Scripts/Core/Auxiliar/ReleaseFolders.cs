...
namespace uAdventure.Core
{
    ...
    public class ReleaseFolders
    {
        ...
        public static string getLanguageFilePath4Editor(bool editor, string language)
        {
            if (editor)
            {
                return UAdventurePaths.EDITOR_RESOURCES_PATH + LANGUAGE_DIR_EDITOR + "/" + language + ".xml";
            }
            else
            {
                return Path.Combine(UAdventurePaths.ENGINE_RESOURCES_PATH + LANGUAGE_DIR_ENGINE, language + ".xml");
            }
        }
        ...
        public static string configFileEditorRelativePath()
        {
            ...
            return UAdventurePaths.PROJECT_RESOURCES_PATH + CONFIG_FILE_PATH_EDITOR;
        }
