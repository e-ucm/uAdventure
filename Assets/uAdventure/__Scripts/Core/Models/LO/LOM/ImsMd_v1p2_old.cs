...
namespace uAdventure.Core.Metadata.ImsMd_v1p2
{
    [XmlType(Namespace = "http://www.imsglobal.org/xsd/imsmd_v1p2")]
    public class ImsMd_v1p2 : ScriptableObject
    {
        [SerializeField]
    ...
    public class General
    {
        ...
        //public CatalogEntry CatalogEntry { get => catalogEntry; set => catalogEntry = value; }
    ...
    {
        [SerializeField]
        private CatalogEntry[] identifier;
        [SerializeField]
        ...
        public CatalogEntry[] Identifier { get => identifier; set => identifier = value; }
