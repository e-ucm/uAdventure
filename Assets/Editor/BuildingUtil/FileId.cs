...
namespace uAdventure.Editor
{
    ...
    public static class FileIDUtil
    {
        ...
        public static void GenerateGUIDMap()
        {
            ...
            Assembly myAssembly = typeof(uAdventure.Runner.Game).GetType().Assembly;
            Dictionary<Type, string> guids = new Dictionary<Type, string>();
            var monobehaviours = FindDerivedTypes(Assembly.GetExecutingAssembly().GetTypes(), typeof(MonoBehaviour));//FindDerivedTypes(GetTypesInNamespace(myAssembly, "uAdventure.Runner"), typeof(MonoBehaviour));
