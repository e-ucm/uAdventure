...
using System;
using UnityEditor;
using CharacterAnimationType = uAdventure.Editor.CharactersWindowAppearance.CharacterAnimationType;
...
namespace uAdventure.Editor
{
    public class PlayerWindowAppearance : LayoutWindow, DialogReceiverInterface
    {
        ...
        public override void Draw(int aID)
        {
            ...
            previewRect2_0 = new Rect(0f, 0.5f * windowHeight, 0.48f * windowWidth, 0.48f * windowHeight);
            previewRect2_1 = new Rect(0.5f * windowWidth, 0.5f * windowHeight, 0.48f * windowWidth, 0.48f * windowHeight);
        ...
        private void OnSlidesceneChangedLookRight(string v)
        {
            ...
            if (!string.IsNullOrEmpty(slidesPathLookRightPreview))
                slidesPreviewLookRight = AssetsController.getImage(
                            slidesPathLookRightPreview).texture;
        }
